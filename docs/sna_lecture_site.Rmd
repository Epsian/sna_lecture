...
toy_network%v%"degree" = degree(toy_network)
## mean geodesic
toy_network%v%"mean_distance" = (colSums(geodist(toy_network)$gdist)) / (nrow(as.sociomatrix(toy_network)) - 1)
...
## degree
toy_attributes$degree = toy_network%v%"degree"
## mean geodesic
toy_attributes$mean_distance = toy_network%v%"mean_distance"
## normalized betweenness
toy_attributes$norm_betweenness = toy_network%v%"norm_betweenness"
## eigenvector
toy_attributes$evc = toy_network%v%"evc"
```
