...
These problems will all relate to a network as a whole. One of the main draws of network analysis is its ability to get a "bird's eye view" of a system that normally we only see a small part of. Take the network below as an example. If you were a node in this network, you would only ever know the nodes directly connected to you.
